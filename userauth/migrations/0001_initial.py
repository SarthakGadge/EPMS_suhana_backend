# Generated by Django 4.1.7 on 2024-11-06 09:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'manager'), ('admin', 'admin'), ('employee', 'employee')], default='employee', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_contact', models.CharField(max_length=15)),
                ('dob', models.DateField()),
                ('employees_supervised', models.ManyToManyField(blank=True, related_name='managers', to='userauth.employee')),
